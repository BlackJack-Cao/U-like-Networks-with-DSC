...
# Dataset parameters
parser.add_argument('-g', '--gt_path', default='/workspace/U-Mamba/data/nnUNet_raw/Dataset703_NeurIPSCell/labelsVal-instance-mask', type=str, help='path to ground truth')
parser.add_argument('-s', '--seg_path', type=str, default='/workspace/U-Mamba/data/nnUNet_raw/Dataset703_NeurIPSCell/UmambabotwDSCPredict', help='path to segmentation results; file names are the same as ground truth', required=False)
parser.add_argument('-thre', '--thresholds', nargs='+', default=[0.5], type=float, help='threshold to count correct cells')
parser.add_argument('-o', '--output_path', default='/workspace/U-Mamba/data/nnUNet_raw/Dataset703_NeurIPSCell/result-umambawDSC', type=str, help='path where to save metrics')
