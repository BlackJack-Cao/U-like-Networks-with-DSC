...
parser.add_argument(
    '--gt_path',
    type=str,
    default='/workspace/U-Mamba/data/nnUNet_raw/Dataset704_Endovis17/labelsTs'
)
parser.add_argument(
    '--seg_path',
    type=str,
    default='/workspace/U-Mamba/data/nnUNet_raw/Dataset704_Endovis17/UmambabotwDSCPredict'
)
parser.add_argument(
    '--save_path',
    type=str,
    default='/workspace/U-Mamba/data/nnUNet_raw/Dataset704_Endovis17/NSD/umambawDSC.csv'
)
