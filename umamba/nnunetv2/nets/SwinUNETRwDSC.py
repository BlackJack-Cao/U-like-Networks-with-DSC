...
class SwinUNETRwDSC(nn.Module):
    ...
    def __init__(
        ...
        # 只为最深层次跳跃连接添加DMSK和TTT模块
        # 对应encoder10的输出，通道数为16 * feature_size
        self.dmsk = DMSKModule(dim=16 * feature_size)
        self.ttt = TTTLayer(dim=16 * feature_size)
