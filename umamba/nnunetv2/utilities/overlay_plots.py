...
def entry_point_generate_overlay():
    ...
    parser.add_argument('-d', type=str,default=703,help="Dataset name or id", required=True)
    parser.add_argument('-o', type=str,default='/home/caoyue/U-Mamba/data/nnUNet_raw/703', help="output folder", required=True)
