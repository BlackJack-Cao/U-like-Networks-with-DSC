...
from nnunetv2.nets.SwinUNETRwDSC import SwinUNETRwDSC

class nnUNetTrainerSwinUNETRwDSC(nnUNetTrainerNoDeepSupervision):
    """
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        print(f"DEBUG: num_input_channels={num_input_channels}, img_size={img_size}, spatial_dims={spatial_dims}")
